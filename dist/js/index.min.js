! function(e) {
    ...
    */
    ...
    function s(e, t) {
        ...
        for (var n = i(e), r = n.tokens, o = 0, a = "", u = 0, s = [], c = void 0, p = void 0, f = void 0, d = 0, h = r.length; d < h; ++d)
            ...
            if (p = c.substring(1), f = t[p], null != f || o > 0 || l()(!1), null == f) {
                if (o) {
                    s[o - 1] = "";
                    for (var v = r.indexOf(c), y = r.slice(v, r.length), g = -1, b = 0; b < y.length; b++)
                        if (")" == y[b]) {
                            g = b;
                            break
                        }
    ...
    var i = n(4),
        a = n(12),
        u = (n(1), n(117), Object.prototype.hasOwnProperty),
        s = n(115),
        c = {
            key: !0,
            ref: !0,
    ...
    var o = n(160),
        ...
        l = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                ...
                v = [],
                y = function() {
                    return d && d.action === s.POP ? v.indexOf(d.key) : f ? v.indexOf(f.key) : -1
                },
                g = function(e) {
                    var t = y();
                    f = e, f.action === s.PUSH ? v = [].concat(v.slice(0, t + 1), [f.key]) : f.action === s.REPLACE && (v[t] = f.key), m.forEach(function(e) {
                        return e(f)
                    })
                },
                b = function(e) {
        ...
        v = a.a.createClass({
            ...
            render: function() {
                var e = this,
                    ...
                    d = t.router,
                    h = null;
                return f && (h = f.reduceRight(function(t, o, a) {
                    if (null == o) return t;
                    var f = i[a],
                        h = n.i(u.a)(f, s),
                        m = {
                    ...
                    if (n.i(c.b)(t)) m.children = t;
                    else if (t)
                        for (var v in t) Object.prototype.hasOwnProperty.call(t, v) && (m[v] = t[v]);
                    if ("object" === (void 0 === o ? "undefined" : p(o))) {
                        var y = {};
                        for (var g in o) Object.prototype.hasOwnProperty.call(o, g) && (y[g] = e.createElement(o[g], l({
                            key: g
                        }, m)));
                        return y
                    }
                    return e.createElement(o, m)
                }, h)), null === h || h === !1 || a.a.isValidElement(h) || o()(!1), h
            }
        });
    t.a = v
}, function(e, t, n) {
    ...
    }, t.removeStockItem = function(e, t) {
        return {
    ...
    var r = function(e) {
        for (var t = [], n = 0; n < e; n++) t.push(n + 1);
        return t
    };
    t.default = r
}, function(e, t, n) {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    s = function(e) {
                        ...
                        var t = "string" == typeof e ? (0, u.parsePath)(e) : e,
                            n = t.pathname;
                        return o({}, t, {
                            pathname: ("/" === r.slice(-1) ? r : r + "/") + ("/" === n.charAt(0) ? n.slice(1) : n)
                        })
                    };
                return o({}, n, {
    ...
    var F = {
        ...
        _renderNewRootComponent: function(e, t, n, r) {
            ...
            var o = k(e, !1);
            return T.batchedUpdates(u, o, t, n, r), L[o._instance.rootID] = o, o
        },
        ...
        _renderSubtreeIntoContainer: function(e, t, n, r) {
            ...
            var l = f(n);
            if (l) {
                if (R(l._currentElement.props.child, t)) {
                    var p = l._renderedComponent.getPublicInstance(),
                        h = r && function() {
                            r.call(p)
                        };
                    return F._updateRootComponent(l, u, a, n, h), p
                }
            ...
            var m = o(n),
                ...
                g = c(n),
                b = y && !l && !g,
                _ = F._renderNewRootComponent(u, n, b, a)._renderedComponent.getPublicInstance();
            return r && r.call(_), _
        },
            ...
            var a = t.displayName || t.name || "Component",
                ...
                f = function(a) {
                    function p(e, t) {
                        ...
                        return n.version = A, n.state = {}, n.renderCount = 0, n.store = e[k] || t[k], n.propsMode = Boolean(e[k]), n.setWrappedInstance = n.setWrappedInstance.bind(n), d()(n.store, 'Could not find "' + k + '" in either the context or props of "' + c + '". Either wrap the root component in a <Provider>, or explicitly pass "' + k + '" as a prop to "' + c + '".'), n.initSelector(), n.initSubscription(), n
                    }
                    return i(p, a), p.prototype.getChildContext = function() {
                        ...
                        return d()(R, "To access the wrapped instance, you need to specify { withRef: true } in the options argument of the " + E + "() call."), this.wrappedInstance
                        ...
                        if (!(R || w || this.propsMode && this.subscription)) return e;
                        var t = y({}, e);
                        return R && (t.ref = this.setWrappedInstance), w && (t[w] = this.renderCount++), this.propsMode && this.subscription && (t[N] = this.subscription), t
        ...
        C = c.a.createClass({
            ...
            handleClick: function(e) {
                if (this.props.onClick && this.props.onClick(e), !e.defaultPrevented) {
                    ...
                    t || p()(!1), !i(e) && o(e) && (this.props.target || (e.preventDefault(), t.push(u(this.props.to, t))))
                }
            },
            render: function() {
                var e = this.props,
                ...
                if (l) {
                    ...
                    var p = u(t, l);
                    s.href = l.createHref(p), (n || null != o && !a(o)) && l.isActive(p, i) && (n && (s.className ? s.className += " " + n : s.className = n), o && (s.style = h({}, s.style, o)))
                }
                return c.a.createElement("a", h({}, s, {
                ...
                createRouteFromReactElement: function(e) {
                    ...
                    return t.from && (t.path = t.from), t.onEnter = function(e, r) {
                        var o = e.location,
                            i = e.params,
                            a = void 0;
                        if ("/" === t.to.charAt(0)) a = n.i(s.a)(t.to, i);
                        else if (t.to) {
                            var u = e.routes.indexOf(t),
                                c = d.getRoutePattern(e.routes, u - 1),
                                l = c.replace(/\/*$/, "/") + t.to;
                            a = n.i(s.a)(l, i)
                        } else a = o.pathname;
                        r({
    ...
    function o(e, t) {
        ...
        function p(e, r) {
            C && C.location === e ? f(C, r) : n.i(c.a)(t, e, function(t, n) {
                t ? r(t) : n ? f(l({}, n, {
                    location: e
                }), r) : r()
            })
        ...
        function f(e, t) {
            ...
            var u = n.i(i.a)(_, e),
                ...
                p = u.changeRoutes,
                f = u.enterRoutes;
            n.i(a.a)(c, _), c.filter(function(e) {
                return f.indexOf(e) === -1
            }).forEach(y), n.i(a.b)(p, _, e, function(t, i) {
                if (t || i) return o(t, i);
                n.i(a.c)(f, e, r)
            })
        }
        ...
        function m(e, r) {
            n.i(c.a)(t, e, function(t, o) {
                ...
                for (var a = h(n.i(i.a)(_, C).leaveRoutes), u = void 0, s = 0, c = a.length; null == u && s < c; ++s) u = a[s](e);
                r(u)
            })
        }
        ...
        function y(e) {
            var t = d(e);
            t && (delete P[t], r(P) || (w && (w(), w = null), x && (x(), x = null)))
        }

        function g(t, n) {
            var o = !r(P);
            return P[d(t, !0)] = n, o && (w = e.listenBefore(m), e.listenBeforeUnload && (x = e.listenBeforeUnload(v))),
                function() {
                    y(t)
                }
        }
    ...
    var o = n(17),
        ...
        c = function(e, t) {
            return {
                id: t.id,
                count: e.stock.find(function(e) {
                    return e.id === t.id
                }).count,
                inCart: e.cart.some(function(e) {
                    return e.id === t.id
                })
            }
        },
        l = function(e, t, n) {
            var r = e.inCart ? i.updateCartItem : i.addToCart;
    ...
    t.default = (0, o.connect)(c, null, l)(u.default)
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(17),
        ...
        c = function(e) {
            return {
                cart: e.cart.map(function(t) {
                    var n = e.stock.find(function(e) {
                        return t.id === e.id
                    });
                    return {
                        id: t.id,
        ...
        l = function(e) {
            return {
                onQtyChange: function(t, n) {
                    e((0, i.updateCartItem)(n, s(t)))
                },
                onRemoveClick: function(t, n) {
                    t.preventDefault(), e((0, i.removeFromCart)(n))
                },
                dispatch: e
            }
        },
        p = function(e, t, n) {
            return Object.assign({}, n, e, t, {
                onPayClick: function() {
                    return e.cart.map(function(e) {
                        return function() {
                            t.dispatch((0, i.removeStockItem)(e.id, e.count)), t.dispatch((0, i.removeFromCart)(e.id))
                        }()
                    })
                }
            })
        };
    t.default = (0, o.connect)(c, l, p)(u.default)
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(17),
        ...
        s = function(e) {
            return !e.includes("cart")
        },
        c = function(e, t) {
            return {
                children: t.children,
                cartItems: e.cart.length,
                backButton: u(t.location.pathname),
                cartButton: s(t.location.pathname)
            }
        };
    t.default = (0, o.connect)(c)(a.default)
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(17),
        ...
        a = r(i),
        u = function(e, t) {
            return e.stock.find(function(e) {
                return String(e.id) === t.params.id
            })
        };
    t.default = (0, o.connect)(u)(a.default)
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(2),
        ...
        s = function(e) {
            var t = e.id,
                n = e.count,
                r = e.onSubmit;
            return n ? i.default.createElement("form", {
                className: "item-add-form",
                onSubmit: function(e) {
                    e.preventDefault(), r(e, t)
                }
            }, i.default.createElement("span", {
                className: "item-qty-label"
            }, "Qty:"), i.default.createElement("select", {
                className: "item-qty"
                ...
                type: "submit"
            }, "Add to cart")) : i.default.createElement("p", {
                className: "item-sold-out"
            }, "Sold out!")
        };
    s.propTypes = {
        id: o.PropTypes.number.isRequired,
        count: o.PropTypes.number.isRequired,
        onSubmit: o.PropTypes.func.isRequired
    }, t.default = s
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(2),
        ...
        f = function(e) {
            ...
            }, "My Cart"), i.default.createElement(u.default, {
                cart: t,
                onQtyChange: n,
                onRemoveClick: r
    ...
    f.propTypes = {
        cart: o.PropTypes.arrayOf(o.PropTypes.shape({
            id: o.PropTypes.number.isRequired,
            name: o.PropTypes.string.isRequired,
            price: o.PropTypes.number.isRequired,
            count: o.PropTypes.number.isRequired,
            stockCount: o.PropTypes.number.isRequired
        }).isRequired).isRequired,
        onQtyChange: o.PropTypes.func.isRequired,
        onRemoveClick: o.PropTypes.func.isRequired,
        onPayClick: o.PropTypes.func.isRequired
    }, t.default = f
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(2),
        ...
        c = function(e) {
            ...
            return i.default.createElement("li", {
                className: "cart-item cart-item-" + t
            }, i.default.createElement(a.Link, {
                to: "/item/" + t,
                className: "cart-item-image-link"
            }, i.default.createElement("img", {
                src: "/assets/" + n.replace(/\s/g, "-").toLowerCase() + "-cart.jpg",
            ...
            }, "$", r.toFixed(2)), i.default.createElement("span", {
    ...
    var o = n(2),
        ...
        s = function(e) {
            var t = e.cart,
                n = e.onQtyChange,
                r = e.onRemoveClick;
            return t.length ? i.default.createElement("ul", {
                ...
                return i.default.createElement(u.default, {
                    ...
                    onQtyChange: function(e, t) {
                        return n(e, t)
                    },
                    onRemoveClick: function(e, t) {
                        return r(e, t)
                    }
                })
    ...
    var o = n(2),
        ...
        u = function(e) {
            ...
            }, r ? u() : "", o ? s() : "")), i.default.createElement("main", {
                className: "main"
            }, t))
        };
    u.propTypes = {
        children: o.PropTypes.node.isRequired,
        cartItems: o.PropTypes.number.isRequired,
        backButton: o.PropTypes.bool.isRequired,
        cartButton: o.PropTypes.bool.isRequired
    }, t.default = u
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(2),
        ...
        s = function(e) {
            var t = e.id,
                ...
                o = e.price;
            return i.default.createElement("div", {
                className: "item item-" + t
            }, i.default.createElement("img", {
                src: "/assets/" + n.replace(/\s/g, "-").toLowerCase() + ".jpg",
                ...
                className: "item-name"
            }, n), i.default.createElement("h2", {
                className: "item-price"
            }, "$", o.toFixed(2)), i.default.createElement("p", {
                className: "item-desc"
    ...
    var o = n(2),
        ...
        s = function() {
            ...
            }, "Shop"), i.default.createElement(u.default, null))
        };
    t.default = s
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(2),
        ...
        u = function(e) {
            var t = e.id,
                ...
                r = e.price;
            return i.default.createElement("li", {
                className: "shop-item shop-item-" + t
            }, i.default.createElement(a.Link, {
                to: "/item/" + t
            }, i.default.createElement("div", {
                className: "shop-item-container"
            }, i.default.createElement("img", {
                src: "assets/" + n.replace(/\s/g, "-").toLowerCase() + "-shop.jpg",
    ...
    s.propTypes = {
        items: o.PropTypes.arrayOf(o.PropTypes.shape({
            id: o.PropTypes.number.isRequired,
            name: o.PropTypes.string.isRequired,
            description: o.PropTypes.string.isRequired,
            price: o.PropTypes.number.isRequired,
    ...
    var o = n(2),
        ...
        a = function(e) {
            ...
            }, "Total:"), i.default.createElement("span", {
    ...
    var i = n(145),
        ...
        u = function() {
            ...
            switch (t.type) {
                case "ADD_TO_CART":
                    return [].concat(o(e), [(0, a.default)(void 0, t)]);
    ...
    var i = n(15),
        ...
        v = (t.startListener = function(e, t, n) {
            var r = function() {
                ...
                o = p(),
                i = t.encodePath(o);
            return o !== i && d(i), (0, u.addEventListener)(window, l, r),
                function() {
            ...
            void 0 !== o && (a = (0, c.addQueryStringValueToPath)(a, n, i), (0, s.saveState)(i, o)), m = e, r(a)
        });
    ...
    var i = Object.assign || function(e) {
        ...
        g = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            c.canUseDOM || (0, s.default)(!1);
            var t = e.queryKey,
                n = e.hashType;
            "string" != typeof t && (t = m), null == n && (n = "slash"), n in y || (n = "slash");
            var r = y[n],
                o = f.getUserConfirmation,
                a = function() {
                ...
                g = void 0,
                b = function(e, n) {
                    1 == ++v && (g = f.startListener(d.transitionTo, r, t));
    ...
    var o = Object.assign || function(e) {
        ...
        h = function() {
            ...
            }), null == v ? v = m.length - 1 : v >= 0 && v < m.length || (0, u.default)(!1);
            var y = d(m),
                g = function(e, t) {
                    return y[e] = t
                },
    ...
    function c(e, t, n, r) {
        var o, c;
        if (_ ? o = i(e) : k ? u(e, n) && (o = T.compositionEnd) : a(e, n) && (o = T.compositionStart), !o) return null;
        P && (k || o !== T.compositionStart ? o === T.compositionEnd && k && (c = k.getData()) : k = m.getPooled(r));
    ...
    function f(e, t, n, r) {
        var o;
        if (!(o = E ? l(e, n) : p(e, n))) return null;
    ...
    function o(e) {
        var t = P.getPooled(O.change, S, e, w(e));
    ...
    function l(e, t) {
        k = e, S = t, R = e.value, M = Object.getOwnPropertyDescriptor(e.constructor.prototype, "value"), Object.defineProperty(k, "value", I), k.attachEvent ? k.attachEvent("onpropertychange", f) : k.addEventListener("propertychange", f, !1)
    }

    function p() {
        k && (delete k.value, k.detachEvent ? k.detachEvent("onpropertychange", f) : k.removeEventListener("propertychange", f, !1), k = null, S = null, R = null, M = null)
    }
    ...
    function m(e, t) {
        if (("topSelectionChange" === e || "topKeyUp" === e || "topKeyDown" === e) && k && k.value !== R) return R = k.value, S
    }
    ...
    var g = n(28),
        ...
        M = null,
        N = !1;
    _.canUseDOM && (N = x("change") && (!document.documentMode || document.documentMode > 8));
    var A = !1;
    _.canUseDOM && (A = x("input") && (!document.documentMode || document.documentMode > 11));
    var I = {
            get: function() {
        ...
        D = {
            ...
            extractEvents: function(e, t, n, o) {
                ...
                if (r(u) ? N ? i = s : a = c : T(u) ? A ? i = d : (i = m, a = h) : v(u) && (i = y), i) {
                    var l = i(e, t);
                    if (l) {
                        var p = P.getPooled(O.change, l, n, o);
    ...
    var _ = 1,
        C = {
            ...
            mountComponent: function(e, t, n, s) {
                ...
                y || null != g && null != g.render ? a(h) ? this._compositeType = b.PureClass : this._compositeType = b.ImpureClass : (l = g, o(h, l), null === g || g === !1 || c.isValidElement(g) || u("105", h.displayName || h.name || "Component"), g = new r(h), this._compositeType = b.StatelessFunctional);
                g.props = p, g.context = f, g.refs = v, g.updater = m, this._instance = g, d.set(g, this);
                var C = g.state;
                void 0 === C && (g.state = C = null), ("object" != typeof C || Array.isArray(C)) && u("106", this.getName() || "ReactCompositeComponent"), this._pendingStateQueue = null, this._pendingReplaceState = !1, this._pendingForceUpdate = !1;
                var E;
            ...
            _renderValidatedComponent: function() {
                ...
                return null === e || e === !1 || c.isValidElement(e) || u("109", this.getName() || "ReactCompositeComponent"), e
            },
    ...
    function o(e, t) {
        t && (Q[e._tag] && (null != t.children || null != t.dangerouslySetInnerHTML) && m("137", e._tag, e._currentElement._owner ? " Check the render method of " + e._currentElement._owner.getName() + "." : ""), null != t.dangerouslySetInnerHTML && (null != t.children && m("60"), "object" == typeof t.dangerouslySetInnerHTML && B in t.dangerouslySetInnerHTML || m("61")), null != t.style && "object" != typeof t.style && m("62", r(e)))
    }

    function i(e, t, n, r) {
        if (!(r instanceof A)) {
            var o = e._hostContainerInfo;
            U(t, o._node && o._node.nodeType === W ? o._node : o._ownerDocument), r.getReactMountReady().enqueue(a, {
                inst: e,
                registrationName: t,
                listener: n
            })
    ...
    function f(e) {
        X.call(G, e) || ($.test(e) || m("65", e), G[e] = !0)
    }
    ...
    h.displayName = "ReactDOMComponent", h.Mixin = {
        mountComponent: function(e, t, n, r) {
            ...
            if (e.useCreateElement) {
                ...
                O.precacheNode(this, d), this._flags |= D.hasCachedChildNodes, this._hostParent || E.setAttributeForRoot(d), this._updateDOMProperties(null, i, e);
                var g = b(d);
                ...
                f = !P && z[this._tag] ? C + "/>" : C + ">" + P + "</" + this._currentElement.type + ">"
            }
            switch (this._tag) {
                case "input":
        ...
        _updateDOMProperties: function(e, t, n) {
            ...
            for (r in e)
                if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
                    ...
                    } else F.hasOwnProperty(r) ? e[r] && L(this, r) : d(this._tag, e) ? H.hasOwnProperty(r) || E.deleteValueForAttribute(j(this), r) : (C.properties[r] || C.isCustomAttribute(r)) && E.deleteValueForProperty(j(this), r);
            for (r in t) {
                var s = t[r],
                ...
                else if (d(this._tag, t)) H.hasOwnProperty(r) || E.setValueForAttribute(j(this), r, s);
        ...
        unmountComponent: function(e) {
            ...
            this.unmountChildren(e), O.uncacheNode(this), P.deleteAllListeners(this), this._rootNodeID = 0, this._domID = 0, this._wrapperState = null
        },
        getPublicInstance: function() {
            return j(this)
        }
    ...
    function a() {
        ...
        return function(e, t, a) {
            var u = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                ...
                P = void 0 === E ? s.a : E,
                w = r(u, ["pure", "areStatesEqual", "areOwnPropsEqual", "areStatePropsEqual", "areMergedPropsEqual"]),
    ...
    var u = (n(105), Object.assign || function(e) {
        for (var t = 1; t < arguments.length; t++) {
            var n = arguments[t];
            for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r])
        }
    ...
    var o = n(6),
        ...
        p = n(14),
        f = n(109),
        d = (n(23), Object.assign || function(e) {
            for (var t = 1; t < arguments.length; t++) {
                var n = arguments[t];
                for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r])
            }
        ...
        y = u.a.createClass({
            ...
            getDefaultProps: function() {
                return {
                    render: function(e) {
                        return u.a.createElement(l.a, e)
                    }
                }
            },
            getInitialState: function() {
            ...
            createRouterObject: function(e) {
                ...
                return n.i(f.a)(r, this.transitionManager, e)
            },
            createTransitionManager: function() {
                ...
                var t = this.props.history,
                    ...
                    o = r.routes,
                    a = r.children;
                return t.getCurrentLocation || i()(!1), n.i(s.a)(t, n.i(p.a)(o || a))
            },
            componentWillMount: function() {
                var e = this;
                this.transitionManager = this.createTransitionManager(), this.router = this.createRouterObject(this.state), this._unlisten = this.transitionManager.listen(function(t, r) {
                    t ? e.handleError(t) : (n.i(f.b)(e.router, r), e.setState(r, e.props.onUpdate))
                })
            },
            ...
            render: function e() {
                var t = this.state,
                    ...
                    s = u.createElement,
                    e = u.render,
                    c = r(u, ["createElement", "render"]);
                return null == n ? null : (Object.keys(y.propTypes).forEach(function(e) {
                    return delete c[e]
                }), e(d({}, c, {
                    router: this.router,
                    location: n,
    ...
    var r = n(2),
        o = n.n(r),
        i = n(68),
        a = (n(23), Object.assign || function(e) {
            for (var t = 1; t < arguments.length; t++) {
                var n = arguments[t];
                for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r])
            }
    ...
    function o(e, t) {
        ...
        o || d || u()(!1), o = o ? o : n.i(s.a)(h);
        var m = n.i(c.a)(o, n.i(l.a)(a));
        d = d ? o.createLocation(d) : o.getCurrentLocation(), m.match(d, function(e, r, a) {
            var u = void 0;
            if (a) {
                var s = n.i(p.a)(o, m, a);
                u = f({}, a, {
            ...
            var h = function(e, r) {
                    ...
                    n.i(c.b)(a.length, function(e, n, r) {
                        o(a[e], t, i, u, function(t, o) {
                            if (t || o) {
                                r(t, [a[e]].concat(Array.isArray(o) ? o : [o]))
                            } else n()
                        })
                    }, function(e, t) {
                        s(null, t)
    ...
    function u(e, t, i, u, c, l) {
        ...
        if ("/" === f.charAt(0) && (i = t.pathname, u = [], c = []), null !== i && f) {
            ...
            if ("" === i) {
                ...
                if ("object" === (void 0 === m ? "undefined" : h(m))) return m.v
            }
        }
    ...
    function o(e, t) {
        ...
        return i.displayName = "withRouter(" + r(e) + ")", i.WrappedComponent = e, l()(i, e)
    }
    var i = n(6),
        a = n.n(i),
        u = n(2),
    ...
    var w = {
        createClass: function(e) {
            ...
            t.prototype = new P, t.prototype.constructor = t, t.prototype.__reactAutoBindPairs = [], b.forEach(i.bind(null, t)), i(t, e), t.getDefaultProps && (t.defaultProps = t.getDefaultProps()), t.prototype.render || f("83");
    ...
    function a(e) {
        function t(t, n, r, i, a, u) {
            var s = t[n];
            if (g(s) !== e) return new o("Invalid " + E[i] + " `" + a + "` of type `" + b(s) + "` supplied to `" + r + "`, expected `" + e + "`.");
            return null
        }
        return i(t)
    }
    ...
    function s(e) {
        function t(t, n, r, i, a) {
            ...
            var u = t[n];
            if (!Array.isArray(u)) {
                return new o("Invalid " + E[i] + " `" + a + "` of type `" + g(u) + "` supplied to `" + r + "`, expected an array.")
            }
            for (var s = 0; s < u.length; s++) {
                var c = e(u, s, r, i, a + "[" + s + "]", P);
    ...
    function c() {
        function e(e, t, n, r, i) {
            ...
            if (!C.isValidElement(a)) {
                return new o("Invalid " + E[r] + " `" + i + "` of type `" + g(a) + "` supplied to `" + n + "`, expected a single ReactElement.")
            }
            return null
        }
        return i(e)
    ...
    function l(e) {
        function t(t, n, r, i, a) {
            if (!(t[n] instanceof e)) {
                var u = E[i],
                    s = e.name || T;
                return new o("Invalid " + u + " `" + a + "` of type `" + _(t[n]) + "` supplied to `" + r + "`, expected instance of `" + s + "`.")
            }
            return null
        }
        return i(t)
    ...
    function p(e) {
        function t(t, n, i, a, u) {
            ...
            return new o("Invalid " + E[a] + " `" + u + "` of value `" + s + "` supplied to `" + i + "`, expected one of " + JSON.stringify(e) + ".")
        }
    ...
    var o = n(2),
        ...
        d = n(124),
        h = r(d),
        m = (0, u.createStore)(l.default, h.default);
    (0, a.render)(i.default.createElement(s.Provider, {
        store: m
